...
public class MySearchAdapter extends RecyclerView.Adapter<MySearchAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public MySearchAdapter(Context context, ArrayList<TwoString> twodataSet, int itemLayout, FragmentManager fgManager, RecyclerView recyclerView) {
    ...
    public void onClick(View v) {
        int curPos = recyclerView.getChildAdapterPosition(v);

        if( v.getId() == R.id.item_myDel)
            twodataSet.remove(curPos);
