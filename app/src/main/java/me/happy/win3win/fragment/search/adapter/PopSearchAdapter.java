package me.happy.win3win.fragment.search.adapter;
...
public class PopSearchAdapter extends RecyclerView.Adapter<PopSearchAdapter.SearchViewHolder> implements View.OnClickListener {
    ...
    private List<Keyword> twodataSet;
    private int itemLayout;
    private FragmentManager fgManager;
    private RecyclerView mRecyclerView;

    public PopSearchAdapter(Context context, List<Keyword> twodataSet, int itemLayout, FragmentManager fgManager, RecyclerView mRecyclerView) {
    ...
    public void onBindViewHolder(SearchViewHolder holder, int position) {
        Keyword keyword = twodataSet.get(position);
